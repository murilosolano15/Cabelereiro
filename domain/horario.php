...
class Horario{
    ...
    public function cadastro(){
        $query = "insert into horario set idcliente=:ic, idservico=:is, idprofissional=:ip, idunidade=:iu, dia=:d, hora=:h";
        ...
        $stmt->bindParam(":ip",$this->idprofissional));
    ...
    public function atualizar(){
        $query = "update horario set idcliente=:ic, idservico=:is, idprofissional=:ip, idunidade=:iu, dia=:d, hora=:h where idhorario=:ih";
